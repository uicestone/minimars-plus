!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : (t.dayjs_plugin_customParseFormat = e());
})(this, function () {
  "use strict";
  var t,
    e = {
  ...
  var c = function (e, i, o) {
    try {
      var s = (function (e) {
          for (
            var i = (e = n(e, t && t.formats)).match(r), o = i.length, s = 0;
            s < o;
            s += 1
          ) {
            var a = i[s],
              ...
              u = f && f[0],
              h = f && f[1];
            i[s] = h ? { regex: u, parser: h } : a.replace(/^\[|\]$/g, "");
          }
          return function (t) {
      ...
      var y = h || 0,
        ...
        $ = l || 0;
      return M
        ? new Date(Date.UTC(p, D, v, y, L, g, $ + 60 * M.offset * 1e3))
        : o
        ? new Date(Date.UTC(p, D, v, y, L, g, $))
        : new Date(p, D, v, y, L, g, $);
    } catch (t) {
      return new Date("");
    }
  };
