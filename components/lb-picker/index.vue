    ...
    >
      <view v-if="showHeader" class="lb-picker-header">
        ...
        <view class="lb-picker-header-actions">
          <!-- 取消 -->
          <view
            class="lb-picker-action lb-picker-action-cancel"
            @tap.stop="handleCancel"
          >
            <slot v-if="$slots['cancel-text']" name="cancel-text"> </slot>
            <text
              v-else
          ...
          <!-- 中间 -->
          <view
            class="lb-picker-action lb-picker-center"
          ...
          <!-- 确定 -->
          <view
            class="lb-picker-action lb-picker-action-confirm"
      ...
      >
        ...
        >
          ...
          <!-- 暂无数据 -->
          <view
            v-if="isEmpty && !loading && mode !== 'dateSelector'"
            class="lb-picker-empty"
          >
            <slot name="empty">
              <text
                class="lb-picker-empty-text"
          ...
          <date-selector-picker
            v-if="mode === 'dateSelector' && !loading"
            :ref="mode"
            :value="value"
            :mode="mode"
            :visible="visible"
        ...
        <!-- 取消 -->
        <view class="picker-bottombox">
          <view class="picker-bottombox_left" v-if="footers">
            <view
              class="lb-picker-bottom-action lb-picker-action-cancel"
              @tap.stop="handleCancel"
            >
              <slot
                v-if="$slots['picker-bottom_left']"
                name="picker-bottom_left"
              ></slot>
            </view>
          </view>
          <view class="picker-bottombox_right" v-if="footers">
            <!-- 确定 -->
            <view
              class="lb-picker-bottom-action lb-picker-action-confirm"
              @tap.stop="handleConfirm"
            >
              <slot
                v-if="$slots['picker-bottom_right']"
                name="picker-bottom_right"
              >
              </slot>
            </view>
          </view>
